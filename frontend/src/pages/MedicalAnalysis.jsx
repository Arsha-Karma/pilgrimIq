...
function MedicalAnalysis() {
    ...
    return (
      <div className="pilgrim-dashboard-wrapper">
        ...
        <div className="pilgrim-dashboard-container" style={{ paddingTop: "72px" }}>
          <UserSidebar activeTab="medical-analysis" />
  ...
  return (
    <div className="pilgrim-dashboard-wrapper">
      ...
      <div className="pilgrim-dashboard-container" style={{ paddingTop: "72px" }}>
        <UserSidebar activeTab="health" />

        <div className="pilgrim-main-content">
          <div className="analysis-page-container" style={{ padding: 0 }}>
            ...
            {successMsg && (
              <div style={{ background: "#064e3b", color: "#a7f3d0", padding: "12px 16px", borderRadius: "10px", marginBottom: "16px", fontWeight: "600" }}>
                ✓ {successMsg}
              </div>
            )}
